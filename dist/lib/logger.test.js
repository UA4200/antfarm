...
describe("logger", () => {
    ...
    describe("formatEntry()", () => {
        ...
        it("includes workflowId when provided", () => {
            ...
            assert.equal(result, "2026-01-01T00:00:00.000Z [WARN] [my-workflow] warning msg");
        });
        it("includes runId (truncated to 8 chars) when provided", () => {
            ...
            assert.equal(result, "2026-01-01T00:00:00.000Z [ERROR] [abcdef01] error msg");
        });
        it("includes stepId when provided", () => {
            ...
            assert.equal(result, "2026-01-01T00:00:00.000Z [DEBUG] [step-build] debug msg");
        });
        it("includes all context fields in correct order", () => {
            ...
            assert.equal(result, "2026-01-01T00:00:00.000Z [INFO] [wf] [12345678] [step1] full context");
        });
    });
